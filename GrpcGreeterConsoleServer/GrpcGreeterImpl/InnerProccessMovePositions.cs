...
namespace GrpcGreeterConsoleServer
{
    ...
    public class InnerProccessMovePositions : IDisposable
    {
        ...
        protected readonly List<WrapRectPosition> list
            = new List<WrapRectPosition>();
        ...
        protected readonly ManualResetEvent mre =
            new ManualResetEvent(false);

        protected readonly List<Task> tasks =
            new List<Task>();

        protected ConcurrentQueue<WrapRectPosition> queue
            = new ConcurrentQueue<WrapRectPosition>();
